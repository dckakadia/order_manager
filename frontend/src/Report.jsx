...
import { Package, Printer, History, X, DollarSign, Clock, CheckCircle } from 'lucide-react';
  ...
  return (
    <div className="grid-1" style={{ gap: '2rem' }}>
      ...
      <div className="stat-cards-grid">
        ...
        <div className="glass-card stat-card">
          ...
          <div className="stat-card-text">
            ...
            <h3 className="stat-card-value">₹{totalRevenue.toLocaleString('en-IN')}</h3>
          </div>
        </div>
        ...
        <div className="glass-card stat-card">
          ...
          <div className="stat-card-text">
            <p className="stat-card-label">Active Pipeline</p>
            <h3 className="stat-card-value">{activeOrders} Orders</h3>
          </div>
        </div>
        ...
        <div className="glass-card stat-card">
          ...
          <div className="stat-card-text">
            ...
            <h3 className="stat-card-value">{completedOrders} Orders</h3>
          </div>
        </div>
      ...
      <div className="glass-card">
        <h2 style={{ marginBottom: '1.5rem', display: 'flex', alignItems: 'flex-start', gap: '0.5rem' }}>
          <Package size={20} style={{ flexShrink: 0, marginTop: '8px' }} /> Production Pipeline Breakdown
        </h2>
      ...
      <div className="glass-card accountant-print-section" style={{ gridColumn: '1 / -1', marginTop: '1rem' }}>
        ...
        {/* Hidden print header */}
        <h1 className="print-only-header" style={{ display: 'none', textAlign: 'center', marginBottom: '20px' }}>Mivox Spas - Order Report</h1>
